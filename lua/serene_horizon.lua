...
local colors = {
  dark = {
    ...
    accent1 = "#4b7a8f",   -- Muted teal (keywords, functions)
    accent2 = "#6d5b9a",   -- Lavender mist (strings, variables)
    accent3 = "#5a8c72",   -- Sage green (numbers, booleans)
    error = "#9e5b5b",     -- Desaturated rose (errors)
    warn = "#9e7a5b",      -- Muted amber (warnings, adjusted for calm)
    info = "#5b9e9e",      -- Soft cyan (info)
    hint = "#7a9e5b",      -- Pale green (hints)
    comment = "#7a8a9a",   -- Grayed lavender (comments, dimmed for subtlety)
    dim = "#3e5a70",       -- Slightly lighter base (highlights, borders)
    bright = "#a0b5c5",    -- Brighter fg variant (for pops without strain)
    black_bg = "#000000",  -- Pure black for variant
  },
  light = {
    bg = "#f0f5fa",        -- Pale sky blue
    fg = "#2a3b4c",        -- Deep slate
    accent1 = "#6a9ab0",   -- Light teal
    accent2 = "#8f7ab8",   -- Soft lilac
    accent3 = "#7ba992",   -- Pale sage
    error = "#b07a7a",     -- Muted coral
    warn = "#b09a7a",      -- Soft amber
    info = "#7ab0b0",      -- Light cyan
    hint = "#9ab07a",      -- Faint green
    comment = "#8a9aaa",   -- Grayed blue
